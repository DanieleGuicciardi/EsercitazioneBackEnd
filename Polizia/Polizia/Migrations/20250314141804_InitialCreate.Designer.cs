...
namespace Polizia.Migrations
{
    ...
    [Migration("20250314141804_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Anagrafica", b =>
                {
            ...
            modelBuilder.Entity("TipoViolazione", b =>
                {
            ...
            modelBuilder.Entity("Verbale", b =>
                {
                    b.HasOne("Anagrafica", "Anagrafica")
                        .WithMany("Verbali")
                        .HasForeignKey("IdAnagrafica")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TipoViolazione", "TipoViolazione")
                        .WithMany("Verbali")
